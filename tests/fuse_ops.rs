...
async fn test_fuse_simple_writes() {
    ...
    let mount_point = format!("/tmp/llmfs-mount-fuse-simple-{}", std::process::id());
    let cache_dir = format!("/tmp/llmfs-mount-fuse-simple-cache-{}", std::process::id());
...
async fn test_fuse_advanced_writes() {
    ...
    let mount_point = format!("/tmp/llmfs-mount-fuse-adv-{}", std::process::id());
    let cache_dir = format!("/tmp/llmfs-mount-fuse-adv-cache-{}", std::process::id());
...
async fn test_fuse_revalidation() {
    ...
    let mount_point = format!("/tmp/llmfs-mount-fuse-reval-{}", std::process::id());
    let cache_dir = format!("/tmp/llmfs-mount-fuse-reval-cache-{}", std::process::id());
